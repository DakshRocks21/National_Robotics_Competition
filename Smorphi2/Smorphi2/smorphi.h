...
// Sensors
  ...
  void module1_sensor_write(int pin_no, int state);

void module2_sensor_write(int pin_no, int state);

void module3_sensor_write(int pin_no, int state);
void module4_sensor_write(int pin_no, int state);
