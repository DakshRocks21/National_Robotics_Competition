...
void Smorphi::HingePivotAnticlockwise(int Speed, int mod)
{
  double w = mapPosAng(Speed);
  switch (mod)
  {
  case 1:
    // Module 1
...
void Smorphi::HingePivotClockwise(int Speed, int mod)
{
  double w = mapPosAng(Speed);
  switch (mod)
  {
